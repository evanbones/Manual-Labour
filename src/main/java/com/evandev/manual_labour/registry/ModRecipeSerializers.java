...
public class ModRecipeSerializers {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<ManualAssemblyRecipe>> MANUAL_ASSEMBLY = RECIPE_SERIALIZERS.register("manual_assembly", ManualAssemblyRecipe.Serializer::new);
}
