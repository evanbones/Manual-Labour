...
public class ModItems {
    ...
    public static final DeferredItem<Item> FLINT_HAMMER = ITEMS.register("flint_hammer", () -> new HammerItem(Tiers.STONE, 7.0f, -3.2f, new Item.Properties(), Ingredient.of(Items.FLINT)));
